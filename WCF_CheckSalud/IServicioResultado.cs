...
namespace WCF_CheckSalud
{
    ...
    {
        [OperationContract]
        ResultadoDC ConsultarResultado(String codResultado);

        [OperationContract]
        List<ResultadoDC> ListarResultado();

        [OperationContract]
        Boolean InsertarResultado(ResultadoDC objResultadoDC);
        ...
        [OperationContract]
        Boolean EliminarResultado(String codResultado);
